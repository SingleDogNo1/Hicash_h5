<template>
	<div class="rate-calculation-body">
		...
		<ul class="select-adress">
			<li
				class="provinceNameShow"
				@click="getProvince"
				:class="{ active: isShowProvinceActive }"
				v-if="isShowProvinceTitle"
			>
				{{ currentProvince }}
			</li>
			<li
				...
				:class="{ active: isShowCityActive }"
				v-if="isShowCityTitle"
			>
				{{ currentCity }}
			</li>
			<li
				...
				:class="{ active: isShowAreaActive }"
				v-if="isShowAreaTitle"
			>
				{{ currentArea }}
			</li>
		</ul>

            ...
            <x-dialog v-model="show" class="dialog-demo">
                <div class="img-box">
                    ...
                    <div class="dialog-content">
                        <strong>是否放弃填写</strong>信息尚未填写完成，是否放弃申请？<br/>现金曾离你这么近，难道就舍它而去？
                    </div>
                    <div class="action">
                        <a href="javascript:void(0);" class="btn-continue" @click="continueWrite">继续填写</a>
            ...
            <div class="content">
                ...
                <div class="img-wrap">
                    ...
                    <form action="" method="post" accept-charset="utf-8">
                        ...
                        <input type="hidden" name="uuid" value="0c8297d7-6d3a-46da-b782-0df2434f88b1">
                    </form>
                    <input type="hidden" v-model="userIdcardFrontUpHidden" class="uphidden" name="upZL112">
                </div>
                <p style="margin-top:.2rem;">照片应同时包含身份证正面像、本人胸部以上头像</p>
                 <p>身份证正面像要求卡片完整、字迹清晰</p>
                <p>本人头像要求五官清晰且无遮挡</p>
                <div class="p03" style="margin-top: -.4rem;margin-bottom:.1rem;
                "><p style="border-bottom:1px solid #ff7640;display: inline-block;">您的身份证需在有效期内方可申请</p></div>
            </div>
            <div class="content">
                ...
                <div class="img-wrap">
                    ...
                    <input type="hidden" class="uphidden" v-model="idcardFrontUpHidden" name="upZL02">
                </div>
            </div>
            <div class="content">
                ...
                <div class="img-wrap">
                    ...
                    <input type="hidden" v-model="idcardBackUpHidden" class="uphidden" name="upZL02">
                </div>
            </div>
        </section>
        <div class="next-step">
    ...
    export default {
        ...
        methods : {
            ...
            userFrontUploadImg (e) {
                ...
                changeImage(this.imgTypeUserFront, postObj, file)
                    .then((data)=>{
                        if(data.resultCode === '1') {
                            _this.userIdcardFrontUrlThum = data.saveFilePathThum + "?t="+Math.random();
            ...
            frontUploadImg (e) {
                ...
                changeImage(this.imgTypeFront, postObj, file)
                    .then((data)=>{
                        if(data.resultCode === '1') {
            ...
            backUploadImg (e) {
                ...
                changeImage(this.imgTypeBack, postObj, file)
                    .then((data)=>{
                        if(data.resultCode === '1') {
            ...
            nextStep () {
                ...
                if(this.userIdcardFrontUrlThum === require("../assets/images/bg_idcard.jpg")){
                    errorMsg = "请上传手持身份证照";
                } else if (this.idcardFrontUrlThum === require("../assets/images/bg_idcard_front.jpg")){
                    errorMsg = "请上传正面照";
                } else if (this.idcardBackUrlThum === require("../assets/images/bg_idcard_back.jpg")){
                    errorMsg = "请上传反面照";
                }
                if(errorMsg != ""){
                ...
                common.updatePicStatus(postData)
                .then((res)=>{
                    if(res.data.resultCode === "1"){
        ...
        mounted: function () {
            ...
            common.checkSupportApp(postData)
                .then((res)=>{
                    if(res.data.resultCode == "1"){
                        ...
                        if(userIdcardFrontUrlThum && idcardFrontUrlThum && idcardBackUrlThum){
                            this.userIdcardFrontUrlThum = userIdcardFrontUrlThum+"?t="+Math.random();

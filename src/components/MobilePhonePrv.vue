    ...
    <div class="rate-calculation-body">
        ...
        <section class="base-main">
            <div class="person-content">
                <label>手机号</label>
                <x-input class="mobile" v-model="mobile" disabled name="directRelativesName" placeholder="请输入手机号" :show-clear="false">
                </x-input>
            </div>
            <div class="person-content">
                <label>服务密码</label>
                <x-input class="password" type="password" autocomplete="off" v-model="password" name="directRelativesName" placeholder="请输入密码" :show-clear="false">
                </x-input>
            </div>
        </section>
        <div class="next-step">

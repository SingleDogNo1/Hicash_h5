  ...
  <div @click="closeMsg" @touchmove="touchmove" @touchstart="touchstart">
    ...
    <scroller lock-x @on-scroll="onScroll" ref="scroller">
      <div class="wrap">
        ...
        <div class="products">
          <div class="tips">
            <span class="red-packet">
              <img src="../images/home/red-packet.png">
            </span>
        ...
        <div class="footer-tips">客服热线：{{serviceTel}}</div>
      </div>
    </scroller>
    <div v-transfer-dom>
      <x-dialog
  ...
  .link {
    ...
    li {
      ...
      .quick-repayment-ico {
        height: 20px;
        display: inline-block;
        background: url("../images/home/icon_s.png") left no-repeat;
        line-height: 20px;
        padding-left: 30px;
      ...
      .help-center-ico {
        height: 20px;
        display: inline-block;
        background: url("../images/home/icon_q.png") left no-repeat;
        line-height: 20px;
        padding-left: 30px;
        background-size: 20px 20px;
      }

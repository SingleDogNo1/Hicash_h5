...
.PersonIndex {
	...
	.brrow-active {
		...
		.nopass-tips {
			...
			.btn {
				...
				.ico-go {
					background: url("../images/person/person_center_go.png") 50% 50%
						no-repeat;
					background-size: 40%;
				}
				.ico-apply {
					background: url("../images/person/person_center_apply.png") 50% 50%
						no-repeat;
					background-size: 24%;
				}
				.title {
	...
	.my-money {
		background: url("../images/person/icon_fenqi.png") no-repeat;
		background-size: 100%;
		background-position-y: rem(4px);
	}

	.my-details {
		background: url("../images/person/icon_transaction_details.png") no-repeat;
		background-size: 100%;
		background-position-y: rem(4px);
	}
	.my-coupon {
		background: url("../images/person/icon_myBorrow.png") no-repeat;
		background-size: 100%;
		background-position-y: rem(4px);
	}
	.my-invitation {
		background: url("../images/person/icon_my_invite.png") no-repeat;
		background-size: 100%;
		background-position-y: rem(4px);
	}
	.my-msg {
		background: url("../images/person/icon_my_info.png") no-repeat;
		background-size: 100%;
		background-position-y: rem(4px);
	}
	.about-us {
		background: url("../images/person/icon_about_us.png") no-repeat;
		background-size: 100%;
		background-position-y: rem(4px);
	}
...
export default {
	...
	methods: {
		showDialog(showDialog) {
			this.isShowCouponPop = showDialog;
		},
	...
	mounted() {
		...
		OwnPageShowData.append("requestSource", this.utils.getApplyFrom());

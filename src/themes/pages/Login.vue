...
#login-body {
	...
	.user-login {
		h2 {
			...
			width: 136px;
			height: 46px;
			background: url("../images/account/logo_user.png") 0 0 no-repeat;
		...
		h2.dida-logo {
			...
			width: 136px;
			height: 46px;
			background: url("../images/account/icon_dida_logo.png") 0 0 no-repeat;
			background-size: 100%;
		}
	}
	.user-login-wrap {
		...
		.message-login-form {
			...
			.mobile {
				...
				background: url("../images/account/icon_tel.png") left center no-repeat;
			...
			.message-code {
				...
				font-size: 15px;
				padding: 5px 0 5px 1.35rem;
				background: url("../images/account/icon_message_code.png") left center no-repeat;
				background-size: 0.666667rem 0.666667rem;
				font-family: PingFangSC-Regular;
				.weui-btn_primary {
			...
			.password {
				...
				font-size: 15px;
				padding: 5px 0 5px 1.35rem;
				background: url("../images/account/icon_password.png") left center no-repeat;
				background-size: 0.666667rem 0.666667rem;
				font-family: PingFangSC-Regular;
			}
			.password:before {
...
export default {
	...
	methods: {
		...
		checkResultBaiQiShi() {
			...
			postData.append("plateform", this.utils.getApplyFrom());
		...
		messageLogin(position) {
			...
			postData.append("requestSource", this.utils.getApplyFrom());
	...
	mounted: function() {
		...
		this.mediasource = window.sessionStorage.getItem("mediasource") || this.$route.query.mediasource;
	}
};
</script>

    ...
    <div class="login-body" id="login-body">
        ...
        <div class="user-login-wrap">
            ...
            <div class="message-login-form" v-if="type === 'message'">
                ...
                <x-input v-model="messageCode" placeholder="输入短信验证码" class="weui-vcode message-code" @keyup.enter.native="messageLogin" keyboard="number" type="tel" :max="5" ref="content" >

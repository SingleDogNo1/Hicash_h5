	...
	<div class="content">
		...
		>
			...
			<div class="loan-detail">
				...
				<p class="item">
					<span class="title">借款期数</span> <span class="value">{{ term }}</span>
				</p>
				...
				<div class="item-wrap" v-for="(item, index) in agreementsH5" :key="index">
					<div class="item">
						...
						<div class="agreement-detail">
							<p
								class="detail-item"
								v-for="(detailItem, index) in item.desDetails"
								:key="index"
							>
							...
							<a
								...
								:href="item.desUrl"
								v-if="item.desTitle && item.desUrl"
								><span>详情</span><x-icon type="ios-arrow-right" size="20"></x-icon
							></a>
						</div>
					</div>

<template>
	<div class="my-news" v-cloak>
		...
		<div
			class="content"
			:style="{ 'padding-top': platform === 'APP' ? 0 : '2.44444rem' }"
		>
			<ul>
						...
						<div class="news-content clearfix">
							...
							<a
								...
								v-if="
									item.isCancel !== 'Y' &&
										item.operate &&
										(item.filterType === 'ljtx' ||
											item.filterType === 'czhk' ||
											item.filterType === 'hinslb' ||
											item.filterType === 'qtxjd' ||
											item.filterType === 'ljqy' ||
											item.filterType === 'hqlsq' ||
											item.filterType === 'linkh5')
								"
								>{{ item.operate }}</a
							>
							<router-link

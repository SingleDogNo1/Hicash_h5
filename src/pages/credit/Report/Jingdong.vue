  ...
  <div class="jingdong">
    ...
    <div class="content">
      <div class="jingdong-report-wrap">
        ...
        <div class="score-wrap">
          <div style="width:150px;z-index:1">
            <x-circle :percent="percent" :stroke-width="4" :trail-width="4" stroke-color="#E61A0F">
              <span class="score-value">{{situation}}</span>
              <p class="score-text">账号活动情况</p>
            </x-circle>
            <p class="icon-verified">实名认证</p>
            <!--<p>未实名</p>-->
            <p class="score-tips">小白信用分 93.5</p>
          </div>
        </div>
      </div>
      <div class="year-consumption-wrap">
        ...
        <div class="tab-wrap">
          <button-tab>
            <button-tab-item selected>2018</button-tab-item>
            <button-tab-item>2018</button-tab-item>
          </button-tab>
          <div class="line"></div>
        </div>

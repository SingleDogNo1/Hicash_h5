		...
		var r = (function() {
			...
			var t = function(t, e) {
				var o = 236,
					...
					A = function() {
						for (
							var r = i.getPatternPosition(s), t = 0;
							t < r.length;
							t += 1
						)
					...
					B = function(r) {
						for (
							var t = i.getBCHTypeNumber(s), e = 0;
							18 > e;
							e += 1
						) {
							var n = !r && 1 == ((t >> e) & 1);
				...
				i = (function() {
					...
					return (
						...
						(f.getLostPoint = function(r) {
							for (
								var t = r.getModuleCount(), e = 0, n = 0;
								t > n;
								n += 1
							)
								for (var o = 0; t > o; o += 1) {
				...
				u = (function() {
					...
					return (
						(e.getRSBlocks = function(r, e) {
							...
							for (
								var i = n.length / 3, a = new Array(), u = 0;
								i > u;
								u += 1
							)
								for (

...
!(function(r) {
	...
	function t(t, e, n, o) {
		function i(r, t) {
			return (
				(r -= o), (t -= o), 0 > r || r >= u || 0 > t || t >= u ? !1 : a.isDark(r, t)
			)
		}
		var a = r(n, e)
				...
				var o = 236,
					...
					M = function(r, t, e) {
						...
						if (c.getLengthInBits() > 8 * h)
							throw new Error(
								"code length overflow. (" + c.getLengthInBits() + ">" + 8 * h + ")"
							)
						for (
					...
					return (
						(e.getRSBlocks = function(r, e) {
							...
							for (var i = n.length / 3, a = new Array(), u = 0; i > u; u += 1)
								for (
									var f = n[3 * u + 0], c = n[3 * u + 1], s = n[3 * u + 2], l = 0;
									f > l;
									l += 1
								)
									a.push(t(c, s))
				...
				d = function(r, t) {
					...
					var a = function(r) {
						...
						u = function(r) {
							...
							return (
								l.write(i.indexOf(d), n), l.write(e, n), l.flush(), c.toByteArray()
							)
						},
						f = function() {
							var r = {},
		...
		;(r.fn.share = function(t) {
						...
						r.each(n, function(n, o) {
							...
							return u.length
								? (u.prop("aria-label", "分享到 " + h[o]),
								  ...
								  void (
										e.initialized || ("prepend" == e.mode ? t.prepend(u) : t.append(u))
								  ))
								: !0
						})
			}
			...
			var f = r(document.head),
				c = {
					...
					source:
						f.find("[name=site], [name=Site]").attr("content") || document.title,
					title:
						f.find("[name=title], [name=Title]").attr("content") || document.title,
					description:

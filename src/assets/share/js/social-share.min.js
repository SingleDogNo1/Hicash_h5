	...
	;(t.prototype = {
		...
		(e.prototype = {
			...
			setupTypeInfo: function(t, e) {
				for (
					var r = (this.errorCorrectLevel << 3) | e, i = d.getBCHTypeInfo(r), n = 0;
					15 > n;
					n++
				) {
					var o = !t && 1 == ((i >> n) & 1)
							...
							for (var l = 0; n > l; l++)
								for (var u = 0; n > u; u++) {
									...
									;(r.strokeStyle = c ? i.colorDark : i.colorLight),
										...
										r.fillRect(d, f, o, a),
										r.strokeRect(Math.floor(d) + 0.5, Math.floor(f) + 0.5, s, h),
	...
	(function(t, e, r) {
		...
		function w(r) {
			...
			~e.readyState.indexOf("m")
				? r()
				: "load DOMContentLoaded readystatechange".replace(/\w+/g, function(o, a) {

	...
	(t.prototype = {
		...
		(e.prototype = {
			...
			setupTypeNumber: function(t) {
				for (
					var e = d.getBCHTypeNumber(this.typeNumber), r = 0;
					18 > r;
					r++
				) {
					var i = !t && 1 == ((e >> r) & 1);
		...
		(e.createData = function(t, r, o) {
			for (
				var a = i.getRSBlocks(t, r), s = new n(), h = 0;
				h < o.length;
				h++
			) {
				var l = o[h];
			...
			d = {
				...
				getMask: function(t, e, r) {
					switch (t) {
						...
						case c.PATTERN100:
							return (
								(Math.floor(e / 2) + Math.floor(r / 3)) % 2 == 0
							);
						case c.PATTERN101:
				...
				return o.length
					? ((o[0].href = n),
					  ...
					  void (
							e.initialized ||
							(i
								? t.insertBefore(o[0], t.firstChild)
								: t.appendChild(o[0]))
					  ))
					: !0;
			});

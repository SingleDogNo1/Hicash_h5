	...
	<div id="app" :class="[path, platform]">
		...
		<x-dialog v-model="authShowDialog" class="app-auth-dialog">
			<div class="img-box">
				...
				<p>
					恭喜获得 <span>{{ couponAmount }}元</span> 优惠券
				</p>
				<div class="btns">
			...
			<div @click="authShowDialog = false"><span class="vux-close"></span></div>
		</x-dialog>
		<!-- <confirm
...
.weui-bar__item_on {
	...
	.icon-kefu {
		background: url("./assets/images/icon_kefu_act.png") center center no-repeat;
		background-size: cover;
	}
}
